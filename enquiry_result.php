...
<form action="resvn.php" method="post" style="font">
Registered Mobile No: <input type="text" name="mno" required="required"/><br><br>
...
echo " <a href=\"http://localhost/project/enquiry.php\">More Enquiry</a> <br>";

$conn->close();
?>

<br><a href="http://localhost/project/index.htm">Go to Home Page!!!</a>
</body>
</html>
