<html>
<body style=" background-image: url(img/img8.jpg);
    height: 100%;
...
<form action="new_png.php" method="post" style="text-align:center">
...
if(mysqli_num_rows($query) == 0)
{
 ...
 echo " <br><a href=\"http://localhost/project/enquiry.php\">Go Back!!!</a> <br>";
 die();
}
...
echo "<a href=\"http://localhost/project/enquiry.php\">Back to Enquiry</a>";
