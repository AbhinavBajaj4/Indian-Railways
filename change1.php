...
$cdquery="SELECT * FROM user WHERE user.mobileno='".$_POST["mno"]."'and user.password='".$pwd."' and user.emailid='".$_POST["email"]."' and user.dob='".$_POST["dob"]."'";
...
if(mysqli_num_rows($cdresult)==0)
{
 ...
 echo " <a href=\"http://localhost/project/change.php\">Fill details again</a><br>";
 die();
}
